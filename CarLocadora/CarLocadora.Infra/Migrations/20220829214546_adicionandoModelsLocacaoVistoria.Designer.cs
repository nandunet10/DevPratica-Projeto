...
namespace CarLocadora.Infra.Migrations
{
    ...
    [Migration("20220829214546_adicionandoModelsLocacaoVistoria")]
    partial class adicionandoModelsLocacaoVistoria
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarLocadora.Modelo.Modelos.LocacaoModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarLocadora.Modelo.Modelos.VistoriasModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarLocadora.Modelo.Modelos.LocacaoModel", b =>
                {
                    b.HasOne("CarLocadora.Modelo.Modelos.CategoriaModel", "CategoriaModel")
                        .WithMany()
                    ...
                    b.HasOne("CarLocadora.Modelo.Modelos.FormasDePagamentoModel", "FormasDePagamento")
                        .WithMany()
                        .HasForeignKey("FormasDePagamentoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CarLocadora.Modelo.Modelos.VistoriasModel", b =>
                {
                    b.HasOne("CarLocadora.Modelo.Modelos.LocacaoModel", "Locacao")
                        .WithMany()
