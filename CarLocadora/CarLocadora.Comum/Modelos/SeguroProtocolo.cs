...
{
    public class SeguroProtocolo
    {
        [Display(Name = "identificador da tabela")] public Int32 Id { get; set; }
        //[Key][Required][StringLength(14, MinimumLength = 14)][DatabaseGenerated(DatabaseGeneratedOption.Identity)] public string CPF { get; set; }
        ...
        [Display(Name = "Numero de protocolo")] public Int32? NumeroProtocolo { get; set; }
