...
namespace CarLocadora.Front.Controllers
{
    public class FormasDePagamentoController : Controller
    {
        ...
        public FormasDePagamentoController(IOptions<DadosBase> dadosBase, IOptions<LoginResposta> loginRespostaModel, IApiToken apiToken, IHttpClientFactory httpClient)
        {
